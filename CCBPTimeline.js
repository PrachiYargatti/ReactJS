...
//ProjectTimelineCard/index.css
.project-card {
  padding: 15px;
  background: #ffffff;
  border-left: 4px solid #2b237c;
}
.project-image {
  width: 100%;
  border-radius: 6px;
